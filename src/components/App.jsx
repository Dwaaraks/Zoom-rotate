...
const ImageViewer = () => {
  ...
  const handleRotate = () => {
    setRotation(rotation + 90); // Rotate image by 90 degrees
  };
  const handleZoom = () => {
    setZoom(zoom + 0.1); // Rotate image by 90 degrees
  };
  ...
  return (
    ...
    >
      ...
      <Button variant="contained" color="primary" onClick={handleZoom}>
        Zoom
      </Button>
    </Box>
  );
